...
[![Source Code](https://img.shields.io/badge/github-source%20code-blue?logo=github&logoColor=white)](https://github.com/rolehippie/kubeone) [![Testing Build](https://github.com/rolehippie/kubeone/workflows/testing/badge.svg)](https://github.com/rolehippie/kubeone/actions?query=workflow%3Atesting) [![Readme Build](https://github.com/rolehippie/kubeone/workflows/readme/badge.svg)](https://github.com/rolehippie/kubeone/actions?query=workflow%3Areadme) [![Galaxy Build](https://github.com/rolehippie/kubeone/workflows/galaxy/badge.svg)](https://github.com/rolehippie/kubeone/actions?query=workflow%3Agalaxy) [![License: Apache-2.0](https://img.shields.io/github/license/rolehippie/kubeone)](https://github.com/rolehippie/kubeone/blob/master/LICENSE)
...
kubeone_config_content: |
  ...
  dynamicWorkers:
    hosts:
      {{ kubeone_dynamic_workers | from_yaml | to_nice_yaml(indent=2) | indent(width=4, first=False) | trim }}
  {% endif %}
...
```YAML
kubeone_install_path: /opt/kubeone-{{ kubeone_release_version }}
```
...
```YAML
kubeone_kubernetes_version: 1.22.8
```
